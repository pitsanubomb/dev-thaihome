(function () {
  ...
  angular.module('ThaiHome')
        ...
        .state('admin.site-translations.edit', {
          ...
          resolve: {
            ...
            TranslationDef: ['$q', '$http', '$stateParams', 'CONFIG', function ($q, $http, $stateParams, CONFIG) {
              var d = $q.defer();
              $http.get('/translations/' + CONFIG.DEFAULT_LANGUAGE + '.json').then(function (data) {
                d.resolve(data.data);
              }).catch(function () {
                d.reject();
              });
    ...
    .controller('PropertyTranslationsCtrl', ['Translations', 'TranslationData', 'Translation', '$stateParams', '$scope', '$state', 'DTOptionsBuilder', 'Notification', 'Modal', '$rootScope', function (Translations, TranslationData, Translation, $stateParams, $scope, $state, DTOptionsBuilder, Notification, Modal, $rootScope) {
      $scope.dtOptions = DTOptionsBuilder.newOptions();
