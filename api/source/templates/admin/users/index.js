(function () {
  ...
  angular.module('ThaiHome')
    ...
    .controller('UsersCtrl', ['User', '$stateParams', '$scope', '$state', 'Users', 'UserData', 'DTOptionsBuilder', '$rootScope', 'Countries', 'Notification', 'Modal', 'Booking', function (User, $stateParams, $scope, $state, Users, UserData, DTOptionsBuilder, $rootScope, Countries, Notification, Modal, Booking) {
